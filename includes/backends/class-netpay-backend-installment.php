 ...
 *       that have registered with NetPay Thailand account.
 *
 * @since 3.4
 *
 ...
 */
class NetPay_Backend_Installment extends NetPay_Backend {
	/**
	...
	public function initiate() {
		self::$providers = array(
			'installment_first_choice' => array(
				...
				'title'              => __( 'Krungsri First Choice', 'netpay' ),
				'interest_rate'      => 1.3,
			...
			'installment_ktc' => array(
				'bank_code'          => 'ktc',
				'title'              => __( 'Krungthai Card (KTC)', 'netpay' ),
				'interest_rate'      => 0.8,
				'min_allowed_amount' => 300.00,
			),
			...
			'installment_scb' => array(
				'bank_code'          => 'scb',
				'title'              => __( 'Siam Commercial Bank', 'netpay' ),
				'interest_rate'      => 0.74,
				'min_allowed_amount' => 500.00,
			),
		);
