...
class NetPay_Event_Charge_Capture extends NetPay_Event {
	 ...
	 * For on-store capture, it will be handled by NetPay_Payment_Creditcard::process_capture.
	 */
	public function resolve() {
		$this->order->add_order_note( __( 'NetPay: Received charge.capture webhook event.', 'netpay' ) );
