...
if (! class_exists('NetPayPluginHelperCharge')) {
    class NetPayPluginHelperCharge
    {
        ...
        {
            return self::isChargeObject($charge) && $charge['result']['status']=='chargeable';
        }
        ...
        {
            return self::isChargeObject($charge) && $charge['result']['status']=='success';
        }
        ...
        public static function isFailed($charge)
        {
            ...
            if ($charge['result']['status']=='reject')
                return true;
