...
use \NetPay\Handlers\NetPayTokenDataHandler;
...
class NetPayToken
{
    ...
    {
        $fields = NetPayTokenDataHandler::prepare($data);
        $fields_string = json_encode($fields);
        $curl_result = NetPayCurl::post(NetPayConfig::$TOKEN_URL, $fields_string, $privateKey);
