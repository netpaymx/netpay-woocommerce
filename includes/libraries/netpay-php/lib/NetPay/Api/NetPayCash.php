...
use \NetPay\Handlers\NetPayCashDataHandler;
...
class NetPayCash
{
    ...
    {
        $fields = NetPayCashDataHandler::prepare($data);
        $fields_string = json_encode($fields);
        $curl_result = NetPayCurl::post(NetPayConfig::$CASH_URL, $fields_string, $privateKey);
