(function ( $, undefined ) {
    ...
    $(function() {
        ...
        $('body').on('focus', 'input', function() {
            $( "#netpay_installment_number" ).keyup(function() {
				var cardNumber = $("#netpay_installment_number").val().replace(/ /g, '');
            ...
            $( "#netpay_installment_name" ).keypress(function(event) {
            ...
            $('#netpay_installment_name').keyup(function() {
                this.value = this.value.toUpperCase();
                
                var netpay_installment_name = $('#netpay_installment_name').val();
                var fullname = netpay_installment_name.split(' ');
                if(fullname.length >= 2 && fullname[1].length > 0) {
                    $('#netpay_installment_name').parent().find('#netpay_installment_name_validate').remove();
                    $("#netpay_installment_name").css("border-color", "gray");
                }
                else {
                    $('#netpay_installment_name').parent().find('#netpay_installment_name_validate').remove();
                    $("#netpay_installment_name" ).parent().append('<span id="netpay_installment_name_validate"  class="netpay-installment-woocommerce-error"> - Nombre inválido. <br /></span>');
                    $("#netpay_installment_name").css("border-color", "red");
                }
            });
            ...
            $('#netpay_installment_expiration_card').keyup(function() {
                var expiration_card = $('#netpay_installment_expiration_card').val();
            ...
            $('#netpay_installment_security_code').keyup(function() {
                ...
                var security_code = $('#netpay_installment_security_code').val();
            ...
            $( "#netpay_installment_number" ).on( "click", function() {
