...
class NetPay_Backend_Installment_Test extends TestCase {
	public static function setUpBeforeClass(): void {
		NetPay_Unit_Test::include_class( 'backends/class-netpay-backend.php' );
		NetPay_Unit_Test::include_class( 'backends/class-netpay-backend-installment.php' );
	}
	...
	public function get_only_valid_plans_from_given_scb_allowed_installment_terms() {
		$installment_backend = new NetPay_Backend_Installment();
